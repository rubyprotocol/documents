The [repository](https://github.com/Ruby-Protocol/private_ml) contains various functional encryption schemes and several machine learning applications built on top of the schemes.
